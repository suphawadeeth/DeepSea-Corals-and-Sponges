...
SELECT ScientificName, TaxonRank, VernacularNameCategory, DepthInMeters, COUNT(*) AS count
FROM deep_sea_corals
WHERE DepthInMeters IS NOT NULL AND DepthInMeters > 3000 < 5000
...
-- Show the first record of the deep sea, show how deep and what's in there and how it was recored
SELECT TaxonRank, 
	ScientificName, 
...
-- Show the newest record of the deep sea, show how deep and what's in there and how it was recored
SELECT 
	TaxonRank, 
	ScientificName, 
    VernacularNameCategory, 
